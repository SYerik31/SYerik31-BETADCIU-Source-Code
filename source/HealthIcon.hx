...
class HealthIcon extends FlxSprite
{
	...
	public function useOldSystem(char:String)
	{
		...
		antialiasing = true;
		animation.add('bf', [0, 1, 771], 0, false, isPlayer);
		animation.add('bf-car', [0, 1, 771], 0, false, isPlayer);
		animation.add('bf-christmas', [0, 1, 771], 0, false, isPlayer);
		animation.add('bf-fnf-switch', [0, 1, 771], 0, false, isPlayer);
		animation.add('bf-updike', [0, 1, 771], 0, false, isPlayer);
		animation.add('bf-ghost', [0, 1, 771], 0, false, isPlayer);
		animation.add('bfHalloween', [0, 1, 771], 0, false, isPlayer);
		animation.add('bf-wd', [0, 1, 771], 0, false, isPlayer);
		animation.add('bf-tabi', [0, 1, 771], 0, false, isPlayer);
		animation.add('bf-flipped', [0, 1, 771], 0, false, isPlayer);
		animation.add('spooky', [2, 3, 772], 0, false, isPlayer);
		animation.add('bf-spooky', [2, 3, 772], 0, false);
		animation.add('pico', [4, 5, 773], 0, false, isPlayer);
		animation.add('gf-pico', [4, 5, 773], 0, false, isPlayer);
		animation.add('mom', [6, 7, 798], 0, false, isPlayer);
		animation.add('mom-car', [6, 7, 798], 0, false, isPlayer);
		animation.add('mom-shaded', [6, 7, 798], 0, false, isPlayer);
		animation.add('tankman', [8, 9, 806], 0, false, isPlayer);
		animation.add('face', [10, 11], 0, false, isPlayer);
		animation.add('dad', [12, 13], 0, false, isPlayer);
		animation.add('dad-flipped', [12, 13], 0, false, isPlayer);
		animation.add('bf-old', [14, 15], 0, false, isPlayer);
		animation.add('gf', [16, 17], 0, false, isPlayer);
		animation.add('bf-gf', [16, 17, 774], 0, false, isPlayer);
		animation.add('bf-gf-lullaby', [16, 17, 775], 0, false, isPlayer);
		animation.add('gf-standing', [16, 17, 775], 0, false, isPlayer);
		animation.add('gf-standing-halloween', [16, 17, 775], 0, false, isPlayer);
		animation.add('gf-crucified', [16, 17, 775], 0, false, isPlayer);
		...
		animation.add('hex', [34, 35, 34], 0, false, isPlayer);
		...
		animation.add('bf-exgf', [38, 39, 38], 0, false, isPlayer);
		...
		animation.add('sarvente', [42, 43, 42], 0, false, isPlayer);
		animation.add('sarvente-dark', [43, 43], 0, false, isPlayer);
		animation.add('ruv', [44, 45, 44], 0, false, isPlayer);
		animation.add('bf-sky', [47, 344, 46], 0, false, isPlayer);
		animation.add('sky-happy', [46, 47, 46], 0, false, isPlayer);
		animation.add('sky-purehappiness', [46], 0, false, isPlayer);
		animation.add('drunk-annie', [48, 49, 48], 0, false, isPlayer);
		...
		animation.add('miku-flipped', [52, 53], 0, false, isPlayer);
		...
		animation.add('kapi', [62, 63, 62], 0, false, isPlayer);
		animation.add('liz', [64, 65], 0, false, isPlayer);
		animation.add('tord', [66, 67], 0, false, isPlayer);
		animation.add('agoti', [68, 69, 782], 0, false, isPlayer);
		animation.add('agoti-flipped', [68, 69, 782], 0, false, isPlayer);
		...
		animation.add('sarvente-lucifer', [78, 79, 78], 0, false, isPlayer);
		animation.add('knuckles', [80, 81], 0, false, isPlayer);
		animation.add('lila', [82, 83], 0, false, isPlayer);
		animation.add('garcellotired', [84, 85, 84], 0, false, isPlayer);
		...
		animation.add('botan-aloe', [88, 89, 779], 0, false, isPlayer);
		animation.add('botan', [88, 89, 799], 0, false, isPlayer);
		animation.add('bf-dad', [90, 91], 0, false, isPlayer);
		animation.add('bf-mom', [92, 93, 798], 0, false, isPlayer);
		animation.add('bf-mom-car', [92, 93, 798], 0, false, isPlayer);
		...
		animation.add('blantad-new', [96, 97, 96], 0, false, isPlayer);
		animation.add('blantad-scream', [96, 97], 0, false, isPlayer);
		animation.add('blantad-watch', [96, 97, 96], 0, false, isPlayer);
		...
		animation.add('senpaighosty-flipped', [104], 0, false, isPlayer);
		...
		animation.add('agoti-mad', [112, 113, 785], 0, false, isPlayer);
		...
		animation.add('bf-aloe', [170, 171, 777], 0, false, isPlayer);
		animation.add('bf-aloe-car', [170, 171, 777], 0, false, isPlayer);
		...
		animation.add('bf-nene', [218, 219, 218], 0, false, isPlayer);
		animation.add('bf-nene-scream', [218, 219], 0, false, isPlayer);
		animation.add('bf-nene-flipped', [218, 219, 218], 0, false, isPlayer);
		...
		animation.add('aldryx', [272, 273, 784], 0, false, isPlayer);
		animation.add('aldryx-shaded', [272, 273, 784], 0, false, isPlayer);
		animation.add('aldryx-flipped', [272, 273, 784], 0, false, isPlayer);
		...
		animation.add('soul-tails', [288, 289, 288], 0, false, isPlayer);
		animation.add('steven-pibby', [290, 291], 0, false, isPlayer);
		animation.add('spongebob-pibby', [292, 293], 0, false, isPlayer);
		animation.add('ruby', [294, 295, 800], 0, false, isPlayer);
		animation.add('ruby-worried', [294, 295, 800], 0, false, isPlayer);
		animation.add('ruby-worried-night', [294, 295, 800], 0, false, isPlayer);
		animation.add('ruby-worried-blue', [294, 295, 800], 0, false, isPlayer);
		animation.add('cjClone', [296, 297], 0, false, isPlayer);
		animation.add('bf-sonic', [298, 299, 298], 0, false, isPlayer);
		...
		animation.add('bana', [328, 329, 328], 0, false, isPlayer);
		animation.add('mel', [330, 331, 330], 0, false, isPlayer);
		animation.add('cg5', [332, 333], 0, false, isPlayer);
		animation.add('pumpkinpie', [334, 335], 0, false, isPlayer);
		animation.add('mia', [336, 337, 338], 0, false, isPlayer);
		...
		animation.add('ace', [348, 349, 348], 0, false, isPlayer);
		...
		animation.add('calli-flipped', [420, 421], 0, false, isPlayer);
		...
		animation.add('ron', [426, 427, 778], 0, false, isPlayer);
		...
		animation.add('eteled2', [432, 433, 434], 0, false, isPlayer);
		animation.add('eteled3', [432, 433, 434], 0, false, isPlayer);
		animation.add('pshaggy', [435], 0, false, isPlayer);
		animation.add('glitched-bob', [436, 437, 436], 0, false, isPlayer);
		animation.add('glitched-bob-flipped', [436, 437, 436], 0, false, isPlayer);
		animation.add('bf-new-tabi', [438, 439, 438], 0, false, isPlayer);
		...
		animation.add('monika-real', [450, 451, 450], 0, false, isPlayer);
		animation.add('monisen', [450, 451, 450], 0, false, isPlayer);
		animation.add('monisen2', [450, 451, 450], 0, false, isPlayer);
		animation.add('monika-real-flipped', [450, 451, 450], 0, false, isPlayer);
		animation.add('natsuki', [452, 453, 452], 0, false, isPlayer);
		animation.add('yuri', [454, 455], 0, false, isPlayer);
		animation.add('sayori', [456, 457, 456], 0, false, isPlayer);
		...
		animation.add('mami', [482, 483, 482], 0, false, isPlayer);
		...
		animation.add('nijiam', [490, 491], 0, false, isPlayer);
		...
		animation.add('cuphead', [500, 501, 500], 0, false, isPlayer);
		...
		animation.add('bf-ex-new', [508, 509], 0, false, isPlayer);
		animation.add('void', [510, 511, 814], 0, false, isPlayer);
		animation.add('little-man', [512, 513], 0, false, isPlayer);
		animation.add('little-man-flipped', [512, 513], 0, false, isPlayer);
		...
		animation.add('austin', [554, 555, 810], 0, false, isPlayer);
		animation.add('sez', [556, 557, 566], 0, false, isPlayer);
		...
		animation.add('herobrine-flipped', [602, 603], 0, false, isPlayer);
		...
		animation.add('baldi-angry', [633, 634, 633], 0, false, isPlayer);
		animation.add('neonight', [635, 636, 635], 0, false, isPlayer);
		animation.add('neonight-flipped', [635, 636, 635], 0, false, isPlayer);
		...
		animation.add('sonic-forced', [644, 645, 646], 0, false, isPlayer);
		animation.add('sonic-mad', [646, 647], 0, false, isPlayer);
		animation.add('retro', [648, 649], 0, false, isPlayer);
		animation.add('retro-shaded', [648, 649], 0, false, isPlayer);
		animation.add('sakuroma', [650, 651], 0, false, isPlayer);
		animation.add('sakuroma-new', [650, 651], 0, false, isPlayer);
		animation.add('sakuroma-shaded', [650, 651], 0, false, isPlayer);
		...
		animation.add('mami-holy-flipped', [662, 663], 0, false, isPlayer);
		...
		animation.add('blantad-powers', [676], 0, false, isPlayer);
		animation.add('blantad-powers-flipped', [676], 0, false, isPlayer);
		...
		animation.add('bf-bbpanzu', [692, 693, 692], 0, false, isPlayer);
		...
		animation.add('daidem', [700, 701, 776], 0, false, isPlayer);
		animation.add('bf-six', [702, 703, 775], 0, false, isPlayer);
		animation.add('twinstwo', [704, 705], 0, false, isPlayer);
		animation.add('exe-front', [706, 707], 0, false, isPlayer);
		animation.add('psychic', [708, 709, 708], 0, false, isPlayer);
		animation.add('fujiwara', [710, 711], 0, false, isPlayer);
		animation.add('nikusa', [712, 713, 783], 0, false, isPlayer);
		animation.add('nikusa-shaded', [712, 713, 783], 0, false, isPlayer);
		animation.add('faker', [714, 715], 0, false, isPlayer);
		animation.add('exe-revie', [716, 716, 717], 0, false, isPlayer);
		animation.add('bf-cryingchild', [718, 719], 0, false, isPlayer);
		animation.add('cc', [720, 721], 0, false, isPlayer);
		animation.add('betty-bw', [722, 723], 0, false, isPlayer);
		animation.add('betty', [722, 723, 722], 0, false, isPlayer);
		animation.add('bf-soul', [724, 725], 0, false, isPlayer);
		animation.add('hex-wd', [726, 727], 0, false, isPlayer);
		animation.add('evil-hex', [727], 0, false, isPlayer);
		animation.add('eteled', [728, 729, 770], 0, false, isPlayer);
		animation.add('aflac', [730, 731, 730], 0, false, isPlayer);
		animation.add('aflac-flipped', [730, 731, 730], 0, false, isPlayer);
		animation.add('fleetway', [732, 733, 732], 0, false, isPlayer);
		animation.add('tails-doll', [734], 0, false, isPlayer);
		animation.add('bf-soft', [735, 736, 735], 0, false, isPlayer);
		animation.add('fliqpy', [737, 738, 737], 0, false, isPlayer);
		animation.add('grace', [739, 740, 739], 0, false, isPlayer);
		animation.add('testis', [741, 742, 741], 0, false, isPlayer);
		animation.add('soul-knucks-flipped', [743, 744, 743], 0, false, isPlayer);
		animation.add('devil', [745, 746, 745], 0, false, isPlayer);
		animation.add('exe-trio', [747], 0, false, isPlayer);
		animation.add('eggdickface', [748, 749, 748], 0, false, isPlayer);
		animation.add('garcellored', [750, 751, 750], 0, false, isPlayer);
		animation.add('edd-ch', [752, 753, 752], 0, false, isPlayer);
		animation.add('ash-ex', [754, 755], 0, false, isPlayer);
		animation.add('cerbera-ex', [756, 757], 0, false, isPlayer);
		animation.add('ashbera-ex', [758, 759], 0, false, isPlayer);
		animation.add('gabe', [760, 761, 760], 0, false, isPlayer);
		animation.add('finn', [762, 763, 762], 0, false, isPlayer);
		animation.add('sharv', [764, 765, 764], 0, false, isPlayer);
		animation.add('lylace', [766, 767, 766], 0, false, isPlayer);
		animation.add('sebasy', [768, 769, 768], 0, false, isPlayer);
		animation.add('jack3-1', [780, 781, 780], 0, false, isPlayer);
		animation.add('solazar', [786, 787, 788], 0, false, isPlayer);
		animation.add('senpai-real', [789, 790, 791], 0, false, isPlayer);
		animation.add('angry-senpai', [792, 793, 794], 0, false, isPlayer);
		animation.add('disy', [795, 796, 797], 0, false, isPlayer);
		animation.add('b3-gf-vampire', [801, 802, 803], 0, false, isPlayer);
		animation.add('tord-ch', [804, 805, 804], 0, false, isPlayer);
		animation.add('missa', [807, 808, 809], 0, false, isPlayer);
		animation.add('nusky', [811, 812, 813], 0, false, isPlayer);
		animation.add('swirl', [815, 816, 817], 0, false, isPlayer);
		animation.add('bf-ski', [818, 819, 818], 0, false, isPlayer);
		...
		if (char.contains('pixel') || char.startsWith('spirit') || char.startsWith('monika') && char != 'monika-real')
			antialiasing = false;
	}

...
class HealthIcon extends FlxSprite
{
	...
	public function useOldSystem(char:String)
	{
		...
		animation.add('betty', [722, 723], 0, false, isPlayer);
		...
		animation.add('fliqpy', [737, 738], 0, false, isPlayer);
		animation.add('grace', [739, 740], 0, false, isPlayer);
		animation.add('testis', [741, 742], 0, false, isPlayer);
		animation.add('soul-knucks-flipped', [743, 744], 0, false, isPlayer);
		animation.add('exe-trio', [747], 0, false, isPlayer);
		animation.add('eggdickface', [748, 749], 0, false, isPlayer);
		animation.add('garcellored', [750, 751], 0, false, isPlayer);
		...
		animation.add('happy-senpai', [789, 790, 791], 0, false, isPlayer);
